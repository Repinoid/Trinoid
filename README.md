...
JARы должны соответствовать друг другу, поэтому всё это хозяйство лучше сразу не менять на более свежие - **утомитесь** вылавливать ошибки<br>
...
(5 rows)
```
Имена каталогов - это имена файлов .properties в ***etc/catalog*** (*Прим. Символ '-' в имени каталога недопустим, пользуем '_'*)<br>
`ls -l etc/catalog`
```
...
(3 rows)
```
### Создадим таблицу tablo в схеме schematoz каталога ys3_catalog,<br> это копия трёх строк созданной на предыдущем шаге таблицы aws3_catalog.mini.client
```
